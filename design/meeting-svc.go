	...
	Method("create-meeting", func() {
		...
		HTTP(func() {
			...
			Body(func() {
				...
				Attribute("platform")
				Attribute("early_join_time_minutes")
				Attribute("meeting_type")
				Attribute("visibility")
				Attribute("restricted")
				Attribute("artifact_visibility")
				Attribute("public_link")
				Attribute("recording_enabled")
				Attribute("transcript_enabled")
				Attribute("youtube_upload_enabled")
				Attribute("zoom_config")
			})

...
//
//nolint:unused // Will be implemented when webhook processing is fully integrated
func (h *ZoomWebhookHandler) handleMeetingStarted(ctx context.Context, payload *meetingsvc.ZoomWebhookPayload) (*meetingsvc.ZoomWebhookResponse, error) {
	...
	// TODO: Implement meeting started logic by delegating to service layer
	// This handler should be updated to call a service method that:
	// - Finds the meeting by platform meeting ID
	// - Creates a PastMeeting record with current meeting attributes
	// - Creates PastMeetingParticipant records for all registrants

...
type ITXMeetingAttachmentClient interface {
	...
	UpdateMeetingAttachment(ctx context.Context, meetingID, attachmentID string, req *itx.UpdateMeetingAttachmentRequest) (*itx.MeetingAttachment, error)
...
type ITXPastMeetingAttachmentClient interface {
	...
	UpdatePastMeetingAttachment(ctx context.Context, meetingAndOccurrenceID, attachmentID string, req *itx.UpdatePastMeetingAttachmentRequest) (*itx.PastMeetingAttachment, error)

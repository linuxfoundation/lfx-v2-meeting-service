...
require (
	...
	github.com/linuxfoundation/lfx-v2-fga-sync v0.3.3
	github.com/linuxfoundation/lfx-v2-indexer-service v0.4.23
	github.com/linuxfoundation/lfx-v2-invite-service v0.1.6

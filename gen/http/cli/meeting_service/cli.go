...
func meetingServiceCreateItxRegistrantUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "meeting-service create-itx-registrant --body '{\n      \"attended_occurrence_count\": 4785224435720526523,\n      \"committee_uid\": \"Ut sed.\",\n      \"created_at\": \"Velit provident expedita veritatis eaque explicabo eaque.\",\n      \"created_by\": {\n         \"email\": \"john.doe@example.com\",\n         \"name\": \"John Doe\",\n         \"profile_picture\": \"https://example.com/avatar.jpg\",\n         \"username\": \"jdoe\"\n      },\n      \"email\": \"bobsmith@gmail.com\",\n      \"first_name\": \"Bob\",\n      \"host\": true,\n      \"job_title\": \"developer\",\n      \"last_invite_delivery_description\": \"Veritatis fugiat exercitationem.\",\n      \"last_invite_delivery_status\": \"Numquam consequuntur.\",\n      \"last_invite_received_message_id\": \"Nostrum voluptatum molestiae eos.\",\n      \"last_invite_received_time\": \"Earum sapiente in.\",\n      \"last_name\": \"Smith\",\n      \"modified_at\": \"Quod recusandae aut incidunt omnis dolorem.\",\n      \"occurrence\": \"1666848600\",\n      \"org\": \"google\",\n      \"profile_picture\": \"Eum eaque nihil quasi id deserunt.\",\n      \"total_occurrence_count\": 3945877524347586138,\n      \"type\": \"direct\",\n      \"uid\": \"Odio ut.\",\n      \"updated_by\": {\n         \"email\": \"john.doe@example.com\",\n         \"name\": \"John Doe\",\n         \"profile_picture\": \"https://example.com/avatar.jpg\",\n         \"username\": \"jdoe\"\n      },\n      \"username\": \"testuser\"\n   }' --meeting-id \"1234567890\" --version \"1\" --bearer-token \"eyJhbGci...\"")
}
...
func meetingServiceUpdateItxRegistrantUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "meeting-service update-itx-registrant --body '{\n      \"attended_occurrence_count\": 8041979237813126609,\n      \"committee_uid\": \"Et nobis pariatur ea omnis.\",\n      \"created_at\": \"Alias est.\",\n      \"created_by\": {\n         \"email\": \"john.doe@example.com\",\n         \"name\": \"John Doe\",\n         \"profile_picture\": \"https://example.com/avatar.jpg\",\n         \"username\": \"jdoe\"\n      },\n      \"email\": \"bobsmith@gmail.com\",\n      \"first_name\": \"Bob\",\n      \"host\": false,\n      \"job_title\": \"developer\",\n      \"last_invite_delivery_description\": \"Cum laboriosam enim et officiis qui ut.\",\n      \"last_invite_delivery_status\": \"Aperiam repudiandae.\",\n      \"last_invite_received_message_id\": \"Amet odio quae.\",\n      \"last_invite_received_time\": \"Quasi unde ipsa qui facilis.\",\n      \"last_name\": \"Smith\",\n      \"modified_at\": \"Placeat facere beatae aut aut iure.\",\n      \"occurrence\": \"1666848600\",\n      \"org\": \"google\",\n      \"profile_picture\": \"Laudantium cupiditate delectus atque.\",\n      \"total_occurrence_count\": 6023692518508880622,\n      \"type\": \"committee\",\n      \"uid\": \"Perspiciatis debitis sit praesentium sed reprehenderit dolor.\",\n      \"updated_by\": {\n         \"email\": \"john.doe@example.com\",\n         \"name\": \"John Doe\",\n         \"profile_picture\": \"https://example.com/avatar.jpg\",\n         \"username\": \"jdoe\"\n      },\n      \"username\": \"testuser\"\n   }' --meeting-id \"1234567890\" --registrant-id \"zjkfsdfjdfhg\" --version \"1\" --bearer-token \"eyJhbGci...\"")
}
...
func meetingServiceCreateItxMeetingAttachmentUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "meeting-service create-itx-meeting-attachment --body '{\n      \"category\": \"Meeting Minutes\",\n      \"description\": \"Sint rem non sunt.\",\n      \"link\": \"Magni rerum quia sunt voluptatem consequatur quam.\",\n      \"name\": \"4s\",\n      \"type\": \"file\"\n   }' --meeting-id \"1234567890\" --version \"1\" --bearer-token \"eyJhbGci...\"")
}
...
func meetingServiceGetItxMeetingAttachmentUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "meeting-service get-itx-meeting-attachment --meeting-id \"Aut tenetur.\" --attachment-id \"0c935a79-fb26-43c9-9029-af635767a0af\" --version \"1\" --bearer-token \"eyJhbGci...\"")
}
...
func meetingServiceUpdateItxMeetingAttachmentUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "meeting-service update-itx-meeting-attachment --body '{\n      \"category\": \"Presentation\",\n      \"description\": \"Error dolores ut ex velit qui.\",\n      \"link\": \"Inventore et aliquam sit dolore.\",\n      \"name\": \"Enim veritatis eaque nulla.\",\n      \"type\": \"link\"\n   }' --meeting-id \"Sit sit incidunt ut voluptas consectetur.\" --attachment-id \"565dd4dc-e344-4b49-910d-b247c33027d2\" --version \"1\" --bearer-token \"eyJhbGci...\"")
}
...
func meetingServiceDeleteItxMeetingAttachmentUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "meeting-service delete-itx-meeting-attachment --meeting-id \"Atque eum dolor molestiae non molestiae.\" --attachment-id \"bce629a9-f661-4d29-b140-d81cd7efa982\" --version \"1\" --bearer-token \"eyJhbGci...\"")
}
...
func meetingServiceCreateItxMeetingAttachmentPresignUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "meeting-service create-itx-meeting-attachment-presign --body '{\n      \"category\": \"Other\",\n      \"description\": \"Et qui.\",\n      \"file_size\": 9008515356237187812,\n      \"file_type\": \"Sunt est.\",\n      \"name\": \"Nostrum saepe exercitationem.\"\n   }' --meeting-id \"Architecto nihil eum quis culpa eum adipisci.\" --version \"1\" --bearer-token \"eyJhbGci...\"")
}

...
func meetingServiceGetMeetingsUsage() {
	...
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "meeting-service get-meetings --version \"1\" --include-cancelled-occurrences false --bearer-token \"eyJhbGci...\"")
}

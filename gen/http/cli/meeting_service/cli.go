...
func meetingServiceUpdateMeetingSettingsUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "meeting-service update-meeting-settings --body '{\n      \"organizers\": [\n         \"Fugit dolor necessitatibus dignissimos.\",\n         \"Vitae ipsa minus quis porro.\"\n      ]\n   }' --uid \"7cad5a8d-19d0-41a4-81a6-043453daf9ee\" --version \"1\" --bearer-token \"eyJhbGci...\" --x-sync true --if-match \"123\"")
}
...
func meetingServiceZoomWebhookUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "meeting-service zoom-webhook --body '{\n      \"event\": \"meeting.started\",\n      \"event_ts\": 1609459200000,\n      \"payload\": \"Autem corrupti iusto quaerat a cupiditate incidunt.\"\n   }' --zoom-signature \"Occaecati eaque.\" --zoom-timestamp \"Quisquam dolorem et dignissimos incidunt excepturi.\"")
}
...
func meetingServiceCreateItxMeetingUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "meeting-service create-itx-meeting --body '{\n      \"artifact_visibility\": \"meeting_hosts\",\n      \"committees\": [\n         {\n            \"allowed_voting_statuses\": [\n               \"Minima est non tenetur aliquid est voluptas.\",\n               \"Ut magnam.\",\n               \"Ipsum voluptatem ut voluptas.\",\n               \"Officia maiores.\"\n            ],\n            \"uid\": \"Delectus repudiandae.\"\n         },\n         {\n            \"allowed_voting_statuses\": [\n               \"Minima est non tenetur aliquid est voluptas.\",\n               \"Ut magnam.\",\n               \"Ipsum voluptatem ut voluptas.\",\n               \"Officia maiores.\"\n            ],\n            \"uid\": \"Delectus repudiandae.\"\n         },\n         {\n            \"allowed_voting_statuses\": [\n               \"Minima est non tenetur aliquid est voluptas.\",\n               \"Ut magnam.\",\n               \"Ipsum voluptatem ut voluptas.\",\n               \"Officia maiores.\"\n            ],\n            \"uid\": \"Delectus repudiandae.\"\n         }\n      ],\n      \"description\": \"6up\",\n      \"duration\": 349,\n      \"early_join_time_minutes\": 34,\n      \"meeting_type\": \"None\",\n      \"project_uid\": \"7cad5a8d-19d0-41a4-81a6-043453daf9ee\",\n      \"recording_enabled\": false,\n      \"recurrence\": {\n         \"end_date_time\": \"1988-02-20T18:01:42Z\",\n         \"end_times\": 5070108296669335370,\n         \"monthly_day\": 18,\n         \"monthly_week\": -1,\n         \"monthly_week_day\": 4,\n         \"repeat_interval\": 9085076251459640712,\n         \"type\": 3,\n         \"weekly_days\": \"1,3,5\"\n      },\n      \"restricted\": false,\n      \"start_time\": \"2021-01-01T00:00:00Z\",\n      \"timezone\": \"Omnis itaque et magni ut.\",\n      \"title\": \"Voluptas animi exercitationem quos sint quos omnis.\",\n      \"transcript_enabled\": true,\n      \"visibility\": \"private\",\n      \"youtube_upload_enabled\": false\n   }' --version \"1\" --bearer-token \"eyJhbGci...\" --x-sync true")
}
...
func meetingServiceCreateItxRegistrantUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "meeting-service create-itx-registrant --body '{\n      \"attended_occurrence_count\": 6774209161410307701,\n      \"committee_uid\": \"Fugit expedita.\",\n      \"created_at\": \"Incidunt saepe architecto.\",\n      \"created_by\": {\n         \"email\": \"john.doe@example.com\",\n         \"id\": \"user123\",\n         \"name\": \"John Doe\",\n         \"profile_picture\": \"https://example.com/avatar.jpg\",\n         \"username\": \"jdoe\"\n      },\n      \"email\": \"bobsmith@gmail.com\",\n      \"first_name\": \"Bob\",\n      \"host\": true,\n      \"id\": \"Fugiat in eos.\",\n      \"job_title\": \"developer\",\n      \"last_invite_delivery_description\": \"Voluptatem recusandae voluptatem sed suscipit.\",\n      \"last_invite_delivery_status\": \"Fuga illum aut sit quaerat iusto vel.\",\n      \"last_invite_received_message_id\": \"Iure quidem.\",\n      \"last_invite_received_time\": \"Omnis enim qui voluptas culpa optio occaecati.\",\n      \"last_name\": \"Smith\",\n      \"modified_at\": \"Ea natus quod velit ea ullam.\",\n      \"occurrence\": \"1666848600\",\n      \"org\": \"google\",\n      \"profile_picture\": \"Quia non et tempora est reiciendis tempore.\",\n      \"total_occurrence_count\": 1294614653046793698,\n      \"type\": \"direct\",\n      \"updated_by\": {\n         \"email\": \"john.doe@example.com\",\n         \"id\": \"user123\",\n         \"name\": \"John Doe\",\n         \"profile_picture\": \"https://example.com/avatar.jpg\",\n         \"username\": \"jdoe\"\n      },\n      \"user_id\": \"Illo qui incidunt porro earum quis.\",\n      \"username\": \"testuser\"\n   }' --meeting-id \"1234567890\" --version \"1\" --bearer-token \"eyJhbGci...\"")
}
...
func meetingServiceUpdateItxRegistrantUsage() {
	...
	fmt.Fprintln(os.Stderr)
	fmt.Fprintln(os.Stderr, "Example:")
	fmt.Fprintf(os.Stderr, "    %s %s\n", os.Args[0], "meeting-service update-itx-registrant --body '{\n      \"attended_occurrence_count\": 8064655825721393362,\n      \"committee_uid\": \"Accusamus ad distinctio rerum sed est aut.\",\n      \"created_at\": \"Enim id.\",\n      \"created_by\": {\n         \"email\": \"john.doe@example.com\",\n         \"id\": \"user123\",\n         \"name\": \"John Doe\",\n         \"profile_picture\": \"https://example.com/avatar.jpg\",\n         \"username\": \"jdoe\"\n      },\n      \"email\": \"bobsmith@gmail.com\",\n      \"first_name\": \"Bob\",\n      \"host\": true,\n      \"id\": \"Aut ducimus hic molestiae est officiis.\",\n      \"job_title\": \"developer\",\n      \"last_invite_delivery_description\": \"Nesciunt eos quis fugiat.\",\n      \"last_invite_delivery_status\": \"Repellat eligendi dolor dolor.\",\n      \"last_invite_received_message_id\": \"Molestias natus doloribus.\",\n      \"last_invite_received_time\": \"Earum occaecati voluptates.\",\n      \"last_name\": \"Smith\",\n      \"modified_at\": \"Molestiae totam.\",\n      \"occurrence\": \"1666848600\",\n      \"org\": \"google\",\n      \"profile_picture\": \"Ut et quidem mollitia et eos.\",\n      \"total_occurrence_count\": 1959897883295717147,\n      \"type\": \"direct\",\n      \"updated_by\": {\n         \"email\": \"john.doe@example.com\",\n         \"id\": \"user123\",\n         \"name\": \"John Doe\",\n         \"profile_picture\": \"https://example.com/avatar.jpg\",\n         \"username\": \"jdoe\"\n      },\n      \"user_id\": \"Itaque amet dolores repudiandae.\",\n      \"username\": \"testuser\"\n   }' --meeting-id \"1234567890\" --registrant-id \"zjkfsdfjdfhg\" --version \"1\" --bearer-token \"eyJhbGci...\"")
}
